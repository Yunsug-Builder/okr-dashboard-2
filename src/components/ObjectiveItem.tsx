    ...
    <div ref={setNodeRef} style={style} className="bg-white shadow-md rounded-lg p-4 mb-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center">
            ...
            <h2 className="text-xl font-bold text-gray-800">{objective.title}</h2>
        </div>
        <div className="flex items-center">
            <div className="w-40 bg-gray-200 rounded-full h-4 mr-3">
                <div className="bg-green-500 h-4 rounded-full" style={{ width: `${objective.progress}%` }}></div>
            </div>
            <span className="text-gray-600 mr-3">{objective.progress}%</span>
